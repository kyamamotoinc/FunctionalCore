...
namespace FunctionalCore
{
    internal class Program
    {
        ...
        //    var r1e = rs.MapError(x => x[0]);
        //    var r2e = re.MapError(x => x[0]);
        ...
        //    //成功したときは副作用を実行しない。
        //    int count = 0;
        //    var r16 = r3.TapBoth(_ => count += 1, () => count -= 1); //副作用(外側の変数に束縛)実施される
        //    var r17 = r4.TapBoth(_ => count += 1, () => count -= 1); //副作用(外側の変数に束縛)が実施される
        //    var results = new[]
        //    {
        ...
        //    //-- Recover --
        //    //失敗時に回復させる
        //    //var r20 = r18.Recover(_ => 0);
        //    //var r21 = r19.Recover(_ => 0);
