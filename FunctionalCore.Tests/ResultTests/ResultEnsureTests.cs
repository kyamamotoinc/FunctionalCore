...
public class ResultEnsureTests
{
    ...
    {
        var res = ok.Ensure(x => x > 0, x => "invalid");
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _ = ok.Ensure(null, x => "invalid"));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _ = ok.Ensure(x => false, null));
    }
}
