...
/// <para>Result<E, T>に対するLINQ拡張メソッドを提供する。</para>
/// </summary>
public static class ResultLinq
{
    ...
    /// <para>値をマップして新しいResultを返す。LINQ構文対応</para>
    /// </summary>
    ...
    /// <returns>
    /// A Result with the transformed value, or the original error.
    /// <para>変換後の値を持つResult、または元のエラー。</para>
    /// </returns>
    ...
    /// <para>Resultを返す関数を適用しフラット化する。LINQ構文対応</para>
    /// </summary>
    /// <typeparam name="E">The error type. / エラーの型。</typeparam>
    /// <typeparam name="T">The type of the original value. / 元の値の型。</typeparam>
    ...
    /// <para>投影された値を持つResult、または元のエラー。</para>
    /// </returns>
